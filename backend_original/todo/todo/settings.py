...
SECRET_KEY = 'django-insecure-$7dlt77xcixbdesr=h40syep+av*&p-m@o+7r0drp74n@(9ncd'
...
# The directories where Django will look for static files (in your apps and other places)
STATICFILES_DIRS = [
